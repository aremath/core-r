...
(* OASIS_START *)
(* DO NOT EDIT (digest: 79863c70753ab833254a7cfddaa23923) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Syntax"; "Support"; "Annotations"; "Langutils"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "language"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\028A\148\nL'\196\t\175K\175M\020:\207f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

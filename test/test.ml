...
let test_simple = "Simple" >:::
  [
    "assign.R" >::
      test_file (test_simple_dir () ^ "/assigns.R") 2000
                (rint_vec_of_ints [4]);
    "dots.R" >::
      test_file (test_simple_dir () ^ "/dots.R") 2000
                (rint_vec_of_ints [8; 9; 10]);
    "gt.R" >::
      test_file (test_simple_dir () ^ "/gt.R") 2000
                (rbool_vec_of_bools [0]);
    "arithmetics.R" >::
      test_file (test_simple_dir () ^ "/arithmetics.R") 2000
                (rint_vec_of_ints [600; 906; 604; 912]);
    "vecs.R" >::
      test_file (test_simple_dir () ^ "/vecs.R") 200
                (rint_vec_of_ints [9]);
    "branching.R" >::
      test_file (test_simple_dir () ^ "/branching.R") 2000
                (rint_vec_of_ints [201]);
    "loops.R" >::
      test_file (test_simple_dir () ^ "/loops.R") 2000
                (rint_vec_of_ints [15]);
    "loops-break.R" >::
      test_file (test_simple_dir () ^ "/loops-break.R") 2000
                (rint_vec_of_ints [1]);
    "var-dots.R" >::
      test_file (test_simple_dir () ^ "/var-dots.R") 2000
